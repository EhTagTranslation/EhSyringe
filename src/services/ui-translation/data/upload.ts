...
const data = {
    ...
    'Main gallery title (English Script)': '主标题 (英文)',
    'Original gallery title (Japanese Script) (Optional)': '原始标题 (日文) (可选)',
    ...
    'Please confirm that you wish to disown this gallery. You will no longer be publicly listed as the uploader unless the gallery was published in the last week, and you will not be able to make further changes to it.': '请确认，你需要与这个图片脱离关系，你将不再被公开列为上传者，除非该图库发布未满一周，并且你将不能再对其进行修改。',
    'This gallery has been published, and images can therefore no longer be added, deleted or rearranged.': '这个图库已经发布，因此不能再添加、删除或重新排序图片。',
    'You can create an editable copy of this gallery by clicking the button below. This new version will be linked in': '你可以通过点击下方的按钮来创建可编辑副本。这个新的版本',
    ...
    'The old gallery will remain until the new one is published. Updates that remove valid content will be reverted.': '旧图库将保留到新图库发布。恶意删除有效内容的更新刚被还原。',
