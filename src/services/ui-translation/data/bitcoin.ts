...
merge(/^\/bitcoin\.php/, undefined, {
    ...
    " when the old one is used. You will still be credited if you reuse recent addresses, but please use the currently displayed address whenever possible.": " 当旧的地址被使用时。如果你重复使用之前的地址，仍然会被计入，但请尽可能使用当前显示的地址。",
    "generate a new address": "生成一个新的地址",
    "Send a Bitcoin (BTC) Wallet Address PM": "向PM发送比特币（BTC）钱包地址",
    "You can use this form to send a private message from the gallery system with your wallet address. This guarantees that a given wallet address belongs to you and that it exists in the E-Hentai system.": "你可以使用这个表格，从画廊系统中发送一个私人信息，并附上你的钱包地址。这保证了一个给定的钱包地址属于你，并且它存在于E-Hentai系统中。",
    "Member name: ": "会员名称：",
    ...
    "Pending": "等待",
    "Accepted": "已接受",
    "Available To Apply: ": "可以申请：",
    "       Donation Total: ": "       总捐款额：",
    "       Adopt-a-Server Days: ": "       领养服务器天数：",
    "Current Conversion Rate: ": "当前汇率：",
    "Apply BTC as Donation": "申请BTC作为捐款",
    "Apply BTC as Adopt-a-Server": "申请BTC作为领养服务器",
    "Select slot duration..": "选择时长..",
    "1 Month @ $10/month $10": "1个月 @ $10/月 $10",
    "3 Month @ $9/month $27": "3个月 @ $9/月 $27",
    "6 Month @ $8/month $48": "6个月 @ $8/月 $48",
    "1 Year @ $7/month $84": "1年 @ $7/月 $84",
    "2 Year @ $6/month $144": "2年 @ $6/月 $144",
    "3 Year @ $5/month $180": "3年 @ $5/月 $180",
    ...
    "never drop sharply, but adjusts slowly over time if the real-world rate is more than 10% below the site rate.": "如果现实世界的汇率比网站的低10%以上，网站的汇率不会急剧下降，会随着时间的推移缓慢调整。",
    ...
    "No BCH have been applied yet.": "目前还没使用BCH。",
    "No BTC have been applied yet.": "目前还没使用BTC。",
    "Donation Log": "捐赠日志",
    ...
    "Send a Bitcoin Cash (BCH) Wallet Address PM": "向PM发送比特币现金（BCH）钱包地址",
    "Recent Bitcoin Cash (BCH) Transactions": "最近的比特币现金（BCH）交易",
    "No transactions in the past year.": "在过去一年中没有交易。",
    "Apply BCH as Donation": "使用BCH用于捐款",
    "Apply BCH as Adopt-a-Server": "使用BCH用于领养服务器"
  }, [
