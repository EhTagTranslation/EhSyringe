            ...
            <div id="settingPanel" class="${state.showSettingPanel ? 'open' : ''}">
                            ...
                            <div class="range-box">
                                <input
                                    ...
                                    @change=${(e: Event) =>
                                        this.changeConfigValue(
                                            'introduceImageLevel',
                                            Math.round(parseInt((e.target as HTMLInputElement).value, 10) / 100),
                                        )}
                ...
                <div class="submit-button">
                    <button
                        ...
                        class="big-button ${this.changeConfigUnsaved() ? 'primary' : ''}"
                    >
                        保存
                    </button>
                </div>
                ...
                <div class="head-buttons">
                    ...
                    <div>
                        <a
                            id="settingSwitch"
                            href="#"
                            @click="${() => (state.showSettingPanel = !state.showSettingPanel)}"
                            >设置</a
                        >
                    </div>
                </div>
...
-->
                ...
                <div class="content">
                    ...
                    <button
                        ...
                        class="big-button ${state.updateAvailable ? 'primary' : ''}"
                        id="updateButton"
                    >
                        更新
                    </button>
